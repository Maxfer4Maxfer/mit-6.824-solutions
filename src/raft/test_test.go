...
func TestManyElections2A(t *testing.T) {
	...
	for ii := 1; ii < iters; ii++ {
		...
		i2 := rand.Int() % servers
		i3 := rand.Int() % servers
		fmt.Printf("Test: iteration: %d disconnect %d\n", ii, i1)
		cfg.disconnect(i1)
		fmt.Printf("Test: iteration: %d disconnect %d\n", ii, i2)
		cfg.disconnect(i2)
		fmt.Printf("Test: iteration: %d disconnect %d\n", ii, i3)
		...
		fmt.Printf("Test: iteration: %d connect %d\n", ii, i1)
		cfg.connect(i1)
		fmt.Printf("Test: iteration: %d connect %d\n", ii, i2)
		cfg.connect(i2)
		fmt.Printf("Test: iteration: %d connect %d\n", ii, i3)
...
func TestRPCBytes2B(t *testing.T) {
	...
	for index := 2; index < iters+2; index++ {
		...
		fmt.Printf("Test: sent %d, actual %d\n", sent, cfg.bytesTotal())
	}

	bytes1 := cfg.bytesTotal()
	fmt.Printf("Test: at the end %d\n", bytes1)
	got := bytes1 - bytes0
...
func TestRejoin2B(t *testing.T) {
	...
	leader2 := cfg.checkOneLeader()
	fmt.Printf("Test: disconnect new leader S%d\n", leader2)
	cfg.disconnect(leader2)

	// old leader connected again
	fmt.Printf("Test: connect old leader S%d\n", leader1)
	cfg.connect(leader1)

	cfg.one(104, 2, true)

	// all together now
	fmt.Printf("Test: connect old new leader S%d\n", leader1)
	cfg.connect(leader2)
...
func TestBackup2B(t *testing.T) {
	...
	fmt.Printf("Test: disconnect S%d\n", other)
	fmt.Printf("Test: disconnect S%d (other)\n", other)
